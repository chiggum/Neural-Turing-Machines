...
class NTM:
    ...
    def __theano_build__(self):
        ...
        self.rmsprop_step = function(
            ...
            [o_err, hamm_err, external_output, grad_abs_sum, grad_sum],
...
def run_ntm_copy():
    ...
    max_iter = 1000000
    to_test = True
    test_path = "../model/ntm-COPY-20-2016-03-04-17-06-51.npz"
    ...
    for iter in range(max_iter):
        ...
        if not to_test:
            ...
            print_info("../plots/ntm-info-%s-%d-%d-%d-%s.npz" % (task_name, min_len, max_len, mylen, time_now), 
                                        ext_in_dim, ext_out_dim, mem_shape, n_heads, n_heads, task_name)
